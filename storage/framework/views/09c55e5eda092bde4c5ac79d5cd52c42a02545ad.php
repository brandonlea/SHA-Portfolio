        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-20">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="/hub/products/edit/<?php echo e($data->id); ?>" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                        ...
                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                            <div class="max-w-lg flex rounded-md shadow-sm">
                                                <input required type="text" name="title" id="title" value="<?php echo e($data->title); ?>"
                                    ...
                                    <div
                                        ...
                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                            <textarea required id="short_description" name="short_description" rows="2"
                                                      class="max-w-lg shadow-sm block w-full focus:ring-gray-500 focus:border-gray-500 sm:text-sm border border-gray-300 rounded-md"><?php echo e($data->short_description); ?></textarea>
                                    ...
                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                        ...
                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                            <textarea required id="description" name="description" rows="2"
                                                      class="max-w-lg shadow-sm block w-full focus:ring-gray-500 focus:border-gray-500 sm:text-sm border border-gray-300 rounded-md"><?php echo e($data->description); ?></textarea>
                                            <p class="mt-2 text-sm text-gray-500">
                                        ...
                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                            <div class="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                                <div class="space-y-1 text-center">
                                                    <img id="show-image" src="<?php echo e($data->image); ?>" alt="">
                                                    <div class="flex text-sm text-gray-600">
                                                        <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-gray-600 hover:text-gray-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-gray-500">
                                                            ...
                                                            <input value="<?php echo e($data->image); ?>" onchange="readURL(this)"  id="image" name="image" type="file" class="sr-only">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
...
<?php endif; ?>
<?php /**PATH /Users/brandonlea/PhpstormProjects/saturnportfolio/resources/views/hub/products/update.blade.php ENDPATH**/ ?>