        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-20">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="<?php echo e(route('hub.products.store')); ?>" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200">
                        <?php echo csrf_field(); ?>
                                                ...
                                                <div class="space-y-1 text-center">
                                                    ...
                                                    <div class="flex text-sm text-gray-600">
                                                        <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-gray-600 hover:text-gray-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-gray-500">
                                                            ...
                                                            <input onchange="readURL(this)"  id="image" name="image" type="file" class="sr-only">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
...
<?php endif; ?>
<?php /**PATH /Users/brandonlea/PhpstormProjects/saturnportfolio/resources/views/hub/products/create.blade.php ENDPATH**/ ?>