        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-20">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="<?php echo e(route('hub.vouches.store')); ?>" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/brandonlea/PhpstormProjects/saturnportfolio/resources/views/hub/vouches/create.blade.php ENDPATH**/ ?>