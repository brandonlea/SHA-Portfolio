<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('hub')" :active="request()->routeIs('hub')">
                        {{ __('Hub') }}
                    </x-nav-link>

                    <x-nav-link :href="route('hub.settings')" :active="request()->routeIs('hub.settings')">
                        {{ __('Settings') }}
                    </x-nav-link>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('hub.experience')">
                                        {{ __('All Experiences') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('hub.experience.create')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('hub')" :active="request()->routeIs('hub')">
                {{ __('hub') }}
