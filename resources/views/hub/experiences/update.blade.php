        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-20">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="/hub/experience/edit/{{ $data->id }}" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200">
                        @csrf
                            ...
                            <div>
                                ...
                                <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                                    ...
                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                        ...
                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                            <div class="max-w-lg flex rounded-md shadow-sm">
                                                <input required type="text" value="{{ $data->title }}" name="title" id="title"
                                                       class="flex-1 block w-full focus:ring-gray-500 focus:border-gray-500 min-w-0 rounded-md sm:text-sm border-gray-300">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                        ...
                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                            <div class="max-w-lg flex rounded-md shadow-sm">
                                                <input required type="text" value="{{ $data->date }}" name="date" id="date"
                                                       class="flex-1 block w-full focus:ring-gray-500 focus:border-gray-500 min-w-0 rounded-md sm:text-sm border-gray-300">
                                            </div>
                                        </div>
                                    </div>
