                            ...
                            <table class="w-auto divide-y divide-gray-200">
                                ...
                                @foreach($data as $vouch)
                                    <tr class="bg-white">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ Str::limit($vouch->vouch, 40, $end='...') }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="vouches/edit/{{ $vouch->id }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <form action="/hub/vouches/delete/{{ $vouch->id }}" method="post">
                                                @csrf
