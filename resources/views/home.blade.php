...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="/images/pp_no_bg.png"/>
    </head>
    <body>
    <nav>
        <div>
            <div id="navbar" class="fixed z-20 flex items-center justify-between w-full h-16 bg-gray-900">
                <div class="flex-1 flex items-center justify-center sm:items-stretch">
                    <div class="sm:ml-6">
                        <div id="nav-links" class="flex space-x-4">
                            <a href="#" class="px-3 py-2 rounded-md text-sm lg:font-medium sm:font-sm text-white" aria-current="page">HOME</a>

                            <a href="#about" class="hover:text-gray-400 px-3 py-2 rounded-md text-sm lg:font-medium sm:font-sm text-white">ABOUT</a>

                            <a href="#experience" class="hover:text-gray-400 px-3 py-2 px-3 py-2 rounded-md text-sm lg:font-medium sm:font-sm text-white">EXPERIENCE</a>

                            <a href="#products" class="hover:text-gray-400 px-3 py-2 px-3 py-2 rounded-md text-sm lg:font-medium sm:font-sm text-white">PRODUCTS</a>

                            <a href="#vouches" class="hover:text-gray-400 px-3 py-2 px-3 py-2 rounded-md text-sm lg:font-medium sm:font-sm text-white">VOUCHES</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div x-cloak x-data="{ open: false }">
                            ...
                            <div x-show="open" class="fixed z-50 inset-0 overflow-y-auto my-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                                <div class="flex min-h-screen items-center justify-center pt-4 px-4 pb-20 text-center sm:block sm:p-0"
                                    ...
                                    <div class="inline-block  align-bottom bg-gray-200 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle  sm:w-60 sm:p-6"
                                         x-transition:enter="ease-out duration-300"
                                        ...
                                        <div class="sm:flex sm:items-start">
                                            <div class="pt-8 text-center sm:mt-0 sm:ml-4 sm:text-center">
                                                <img class="mx-auto w-20 h-20 pb-3" src="{{ $product->image }}" alt="">
                                                <h3 class="pt-8 text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                                    {{ $product->title }}
                                                </h3>
                                                <div class="mt-2">
                                        ...
                                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                            ...
                                            <div class="pr-5">
                                                <a class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm" href="{{ $product->link }}" target="_blank">
                                                    View Wiki
                                                </a>
                                            </div>
                                        </div>
